...
import './symbolLocations.test';
import './renameCore.test';
import './declarationList.test';
import './symbolScope.test';
import './referenceSyntax.test';
import './gplReservedWords.test';
import './deployLock.test';
import './operationStore.test';
import './deployProvenance.test';
import './automationRecovery.test';
...
import './sourcePromotion.test';
import './syncManifest.test';
import './blockContext.test';
import './breakpointReconcile.test';
